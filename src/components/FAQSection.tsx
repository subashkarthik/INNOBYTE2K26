  ...
  >
    ...
    >
      ...
      <motion.div animate={{ rotate: isOpen ? 180 : 0 }} transition={{ duration: 0.2 }} className="shrink-0">
        <ChevronDown size={20} className={isOpen ? 'text-brand-primary' : 'text-slate-500'} />
      </motion.div>
    </button>
    <AnimatePresence>
      {isOpen && (
  ...
  return (
    <section id="faq" className="py-32 px-6 max-w-4xl mx-auto">
      ...
      >
        ...
        <p className="text-slate-400 text-lg">Everything you need to know about INNOBYTE2K26.</p>
      </motion.div>
      ...
      >
        ...
        <a href="#contact" className="text-brand-primary hover:underline">Contact us directly →</a>
      </motion.p>
    </section>
  );
}
